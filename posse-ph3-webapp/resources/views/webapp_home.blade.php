            ...
            <header class="header_in" id="header_in">
                <div class="logoAND4">
                    <div class="posselogo" id="posselogo">
                        <img src="{{ asset('/img/posselogowhite.jpg') }}" width=120px height=24px alt="posseのロゴ">
                    </div>
                    ...
                    <div class="popup-inner" id="popup-inner">
                        ...
                        <div class="modal_main" id="modal_main">
                            ...
                            <div class="modal_button" id="modal_button">
                                <a class="modal_button_figure" id="modal_button_figure">記録・投稿</a>
                            </div>
                        </div>
                        <div class="success" id="success">
                            <div class="success_modal_contents" id="modal_contents">
                                <div class="awesome">AWESOME!</div>
                                <div class="back-circle"></div>
                                <div>
                                    <p class="success_sentence">記録・投稿<br>
                                        完了しました</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="hoursData" id="hoursData">
                <div class="hoursDataS" id="hoursDataS">
                    <div class="todayData" id="todayData">
                        <h3>Today</h3>
                        <p class="study_figure">{{ $today_study_time }}</p>
                        <p class="hour">hour</p>
                    </div>
                    <div class="monthData" id="monthData">
                        <h3>Month</h3>
                        <p class="study_figure">{{ $thismonth_study_time }}</p>
                        <p class="hour">hour</p>
                    </div>
                    <div class="totalData" id="totalData">
                        <h3>Total</h3>
                        <p class="study_figure">{{ $thisyear_study_time }}</p>
                        <p class="hour">hour</p>
                    </div>
                </div>
                <div class="graph">
                    ...
                    <script>
                        ...
                        var myBar = new Chart(ctx, {
                            ...
                            data: { //◆データ
                                ...
                                datasets: [{ //データ設定
                                    data: [
                                        @foreach ($each_day_study_times as $each_day_study_time)
                                            {{ $each_day_study_time }},
                                        @endforeach
                                    ], //データ内容
                        ...
                        var myPieChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    ...
                                    data: [
                                        @foreach ($study_time_languages as $study_time_language)
                                            {{ $study_time_language->total_time }},
                                        @endforeach
                                    ],
                                    borderAlign: 'center',
                                    borderWidth: 0,
                        ...
                        var myPieChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    ...
                                    data: [
                                        @foreach ($study_time_contents as $study_time_content)
                                            {{ $study_time_content->total_time }},
                                        @endforeach
                                    ],
                                    borderAlign: 'center',
                                    borderWidth: 0,
